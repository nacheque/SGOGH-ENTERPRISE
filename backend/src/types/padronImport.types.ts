...
export interface PreviewImportPadronResponseDTO {
  total_filas: number;
  validos: number;
  con_errores: number;
...
export interface ConfirmarImportPadronRequestDTO {
  inmueblesAImputar: PadronImportItemDTO[];
}

export interface ConfirmarImportPadronResponseDTO {
  ok: boolean;
  mensaje: string;
